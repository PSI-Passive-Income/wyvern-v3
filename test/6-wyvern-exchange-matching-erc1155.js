...
const {wrap,ZERO_BYTES32,NULL_SIG,assertIsRejected} = require('./aux')
...
contract('WyvernExchange', (accounts) =>
	...
	let deploy_core_contracts = async () =>
		...
		let [exchange,statici] = await Promise.all([WyvernExchange.new([registry.address],'0x'),WyvernStatic.new(atomicizer.address)])
